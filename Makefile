...
INSTALL_TARGET_PROCESSES = SpringBoard sharingd coreauthd
...
Perseus_FRAMEWORKS = UIKit Security LocalAuthentication
Perseus_PRIVATE_FRAMEWORKS = AppSupport MobileKeyBag
